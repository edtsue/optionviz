...
export function PayoffChart({ data, underlying, breakevens }: Props) {
  return (
    <div className="card">
      ...
      <div className="h-72 w-full">
        <ResponsiveContainer>
          <LineChart data={data} margin={{ top: 8, right: 8, bottom: 8, left: 0 }}>
            ...
            <ReferenceLine x={underlying} stroke="#3b82f6" strokeDasharray="4 4" label={{ value: "now", fill: "#3b82f6", fontSize: 10, position: "insideTop" }} />
            {breakevens.map((b, i) => (
            ...
            <Line type="monotone" dataKey="mid" stroke="#a78bfa" strokeWidth={1.5} dot={false} />
